...
parser.add_argument('--model_id', type=str, default='test_solar_3', help='model id')
# TODO：设置使用的模型
parser.add_argument('--model', type=str, default='Transformer',
                    help='model name, options: [Autoformer, Informer, Transformer]')  # PatchTST  FFTransformer
# TODO:设置读取数据的位置 data loader
...
parser.add_argument('--factor', type=int, default=3, help='attn factor')            # 原本为1，修改为3
...
parser.add_argument('--reverse', action='store_true', help='weather use denormalization', default=True)  # 自己添加的参数
