...
parser.add_argument('--train_only', type=bool, default=False, help='Not implemented')
parser.add_argument('--embed', type=str, default='timeF',
                    help='Not implemented')
# parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
parser.add_argument('--model_id', type=str, default='test', help='model id')
parser.add_argument('--model', type=str, default='SARIMA',
                    help='model name, options: [Naive, ARIMA, SARIMA, GBRT]')
...
setting = '{}_{}_{}_ft{}_sl{}_pl{}_{}'.format(
    ...
    args.pred_len,
    args.des, 0)
# TODO: 这里统计模型可能存在问题，参考“are Transformer effective in time series”对应的github的issue
